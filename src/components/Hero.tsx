    ...
    <section className="relative overflow-hidden bg-background py-20 lg:py-32">
      ...
      <div className="container mt-12 md:mt-0 relative z-10 mx-auto px-4 max-w-6xl">
        <div className="flex flex-col items-center text-center">
          ...
          >
            সব বয়সের মানুষের জন্য আমাদের এই ফ্রি অনলাইন কুরআন শিক্ষা কেন্দ্র। অভিজ্ঞ শিক্ষকদের তত্ত্বাবধানে তাজবিদ সহ কুরআন শিখুন একদম ফ্রি।
          </motion.p>
          ...
          >
            <div className="flex flex-col items-center">
              ...
              <span className="text-sm text-muted-foreground">সফল শিক্ষার্থী</span>
            </div>
            <div className="flex flex-col items-center">
              <span className="text-3xl font-bold text-primary">২০+</span>
              <span className="text-sm text-muted-foreground">অভিজ্ঞ শিক্ষক</span>
            </div>
            <div className="flex flex-col items-center">
              <span className="text-3xl font-bold text-primary">১০০%</span>
              <span className="text-sm text-muted-foreground">অনলাইন ক্লাস</span>
            </div>
            <div className="flex flex-col items-center">
